...
freeStyleJob(jobPromotion) {
    ...
    publishers {
        extendedEmail {
            ...
            defaultContent("The build $SOLUTION_NAME #$SOURCE_BUILD_NUMBER was successful.<br><br>Check ${BUILD_URL}promotion/ and promote build to be uploaded to the Store.")
